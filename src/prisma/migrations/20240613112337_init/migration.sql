...
CREATE TABLE `carts` (
    ...
    `shippingDetails` LONGTEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE `ratings` ADD CONSTRAINT `ratings_storeId_fkey` FOREIGN KEY (`storeId`) REFERENCES `store`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
