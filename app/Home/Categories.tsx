...
const Categories = (props: Props) => {
  ...
  return (
    <div className={styles.main}>
      ...
      <p>
        Select from variety of good placed by thousands of african vendors in
        the world{" "}
      </p>
        ...
        {categories?.map((categoryProd, index) => {
          ...
          return (
            <SplideSlide key={index}>
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mx-2 my-4">
