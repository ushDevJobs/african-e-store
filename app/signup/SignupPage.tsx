...
//   const [addressErrorMsg, setAddressErrorMsg] = useState<string | boolean>(
//     false
//   );
  ...
  const [postCodeErrorMsg, setPostCodeErrorMsg] = useState<string | boolean>(
    false
  );
  ...
  const [checkboxErrorMsg, setCheckboxErrorMsg] = useState<string | boolean>(
    false
  );
  ...
  function validateFields() {
    ...
    //   formValues.address &&
      ...
      if (!formValues?.houseNumber) {
        setHouseNumberErrorMsg(true);
      } else {
        setHouseNumberErrorMsg(false);
      }
      ...
      <div className={styles.fieldContainer}>
        ...
        <div className={styles.rowForm}>
          ...
          <div className={styles.formField}>
            ...
            <input
              ...
              onChange={(e) => onformValueChange(e, setCofirmPasswordErrorMsg)}
            />
        ...
        <div className={styles.rowForm}>
          ...
          <div className={styles.formField}>
            ...
            {phoneErrorMsg && (
              <span className={styles.errorMsg}>Please enter phone number</span>
            )}
          </div>
        </div>
        ...
        <div className={styles.rowForm}>
          ...
          <div className={styles.formField}>
            ...
            />
            {streetErrorMsg && (
              <span className={styles.errorMsg}>Please enter street name</span>
            )}
          </div>
        </div>
        ...
        <div className={styles.rowForm}>
          ...
          <div className={styles.formField}>
            ...
            <input
              ...
              onChange={(e) => onformValueChange(e, setHouseNumberErrorMsg)}
            />
            {houseNumberErrorMsg && (
              <span className={styles.errorMsg}>Please enter house number</span>
            )}
          </div>
        </div>
        ...
        {/* <div className={styles.formField}>
          ...
          />
          {addressErrorMsg && (
            <span className={styles.errorMsg}>Please enter your address</span>
          )}
        </div> */}
