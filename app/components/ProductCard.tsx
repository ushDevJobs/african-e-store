...
type ProductCardProps = {
  product: {
    ...
    name: string;
    amount: number;
    rating: number | 0; // New rating field
  };
};
...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="relative group block border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
      <Link href={`/products/${product.id}`}>
        <div className="relative w-full h-32 sm:h-32 md:h-48 lg:h-64 xl:h-60">
          <Image
      ...
      <div className="p-2 md:p-3 lg:p-4 pb-4">
