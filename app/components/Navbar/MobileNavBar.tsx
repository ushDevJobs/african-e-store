...
import { DropDownIcon, DropDownIcon2, HamburgerIcon, TimesIcon } from '../SVGs/SVGicons'
    ...
    return (
        <div className={styles.mobileNavbarContainer}>
            <div className={styles.navbar}>
                <Link href={`${pathname.includes('/seller') ? '/seller' : '/'}`} onClick={() => setNavIsOpen(false)}>
                    ...
                    <ul>
                                ...
                                {isDropdownOpen && (
                                    <ul className={styles.dropdownContainer}>
                                        {categories?.slice(0, 6).map((category, index) => (
                                            ...
                                            >
                                                <li
                                                    className={` ${styles.dropdownLi} ${pathname == `/categories/${category.id}` ? styles.active : ""}`}
                                                >
                                                    {category.name}
                                                </li>
                                            </Link>
                                        ...
                                        >
                                            <li
                                                className={` ${styles.dropdownLi} ${pathname == `/categories` ? styles.active : ""}`}
                                            >
                                                See all
                                            </li>
                        ...
                        {isLoggedIn &&
                            <>
                                ...
                                <Link href="/purchase-history" onClick={() => setNavIsOpen(false)}>
                                    <li className={pathname == "/purchase-history" ? styles.active : ""}>
                                        Purchase History
                                    </li>
                                </Link>
