...
import {
  CategoriesResponse,
  CategoryResponse,
} from "@/app/components/models/AllCategories";
...
import {
  CategoriesHeader,
  SingleCategoriesHeader,
} from "@/app/components/CategoriesHeader";
...
const SingleCategoryPage = ({ params }: Props) => {
  ...
  const [retrievedCategories, setRetrievedCategories] = useState<
    CategoriesResponse[]
  >([]);
            ...
            <div className={styles.rhs}>
              <div className="flex flex-col gap-10">
                <div className="flex flex-col">
                  <div className="my-6 justify-between items-start xs:items-start sm:items-center md:items-center lg:items-center xl:items-center flex flex-col xs:flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row wrap w-full gap-4">
                    <h3 className="!text-[24px]">{category?.name}</h3>
                  ...
                  <div className={styles.cards}>
                    {filteredProducts?.length === 0 ? (
                      <p className="h-[40vh] text-center flex flex-col items-center justify-center w-screen md:w-[50vw] text-gray-400">
                        No products found
                      </p>
                    ) : (
