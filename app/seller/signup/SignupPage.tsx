...
} from "@/app/components/constants/catchError";
        ...
        <div className={styles.rowForm}>
          ...
          <div className={styles.formField}>
            ...
            <input
              ...
              onChange={(e) => onformValueChange(e, setCompanyNameErrorMsg)}
            />
            {companyNameErrorMsg && (
              <span className={styles.errorMsg}>Please enter company name</span>
            )}
          </div>
        </div>
        <div className={styles.rowForm}>
